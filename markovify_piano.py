...
Original file is located at
    https://colab.research.google.com/drive/1mQ3s5N6INNcmna0jY4CFlWQexeXyHZzT
...
overlap_ratio = 0.95 #@param {type:"slider", min:0.1, max:1, step:0.05}
let_run_wild = True #@param {type:"boolean"}
...
while (len(Output_TXT_String.split(' ')[1:])-2) < minimum_notes_to_generate:
  ...
  if not let_run_wild:
    ...
    out = markov_text_model.make_sentence()
...
full_path_to_input_MIDI_file = "/content/USSR.mid" #@param {type:"string"}
...
Output_TXT = str(TXT[0]) + ' ' + ' '.join(TXT[1:-2]) + ' ' + Output_TXT_String
Output_TXT_String = Output_TXT
