...
Original file is located at
    https://colab.research.google.com/drive/1WF2PofcB8ZCTuOmGjqD4J9tIaMwQFe6q
...
print('Creating list of MIDI files...')
...
MusicDataset = [chords_list_f, melody_list_f, [TXT_String], filez]
