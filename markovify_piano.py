...
Original file is located at
    https://colab.research.google.com/drive/1cfuBtFCWahJzZimzb6eaJiqQ2bb4K9pm

# Markovify Piano (ver 2.0)
...
for f in tqdm.auto.tqdm(filez):
  try:
    ...
    files_count += 1
    TXT, melody, chords = TMIDI.Optimus_MIDI_TXT_Processor(f, line_by_line_output=False, chordify_TXT=chordify_input_MIDIs, output_MIDI_channels=False, char_offset=chars_encoding_offset, dataset_MIDI_events_time_denominator=time_denominator, output_velocity=encode_velocities, MIDI_channel=desired_MIDI_channel_to_process)
...
markov_chain_state_size = 2 #@param {type:"slider", min:1, max:10, step:1}
...
minimum_notes_to_generate = 90 #@param {type:"slider", min:10, max:1000, step:10}
overlap_ratio = 0.1 #@param {type:"slider", min:0.1, max:1, step:0.05}
